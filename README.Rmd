...
* Using the information of the modules we calculated, we can also calculate what's the average expression of each module in any set of cells. This, as long as we have a seurat object with the same gene names as the ones used to calculate the modules. This is very useful to calculate expression and module activityin any other dataset, as if it was any gene.
