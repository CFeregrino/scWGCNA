...
if (length(my.oc >0)) {print(paste0("The following genes we're only highly expressed in less than 3 cells :  ", Expr[my.oc] ))
  Expr=Expr[-my.oc]}
...
if (is.pseudocell) {
  ...
  if (length(which(Matrix::rowSums(datExpr)==0))<1) {
    print(paste0("The following variable genes weew not found expressed in the pseudocell object:  ", names(which(Matrix::rowSums(datExpr)==0))))
  }
